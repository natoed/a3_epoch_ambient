 ...
 */
params [["_initialFog",0.1,[1]], ["_initialOvercast",0.1,[1]], ["_initialRain",0.1,[1]], ["_initialWind",[],[[]]], ["_debug",false,[false]]]; 
...
_rainIntervalRainProbability = 5; // overcast syncing fubar, do not enable rain
